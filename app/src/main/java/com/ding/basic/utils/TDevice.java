...
public class TDevice {
    ...
    public static DisplayMetrics getDisplayMetrics() {
        return MyApplicaion.getContext().getResources().getDisplayMetrics();
    }
    ...
    public static boolean hasInternet() {
        ConnectivityManager cm = (ConnectivityManager) MyApplicaion.getContext()
    ...
    public static boolean isPortrait() {
        return MyApplicaion.getContext().getResources().getConfiguration()
...
//            AppContext.showToast("你手机中没有安装应用市场！");
    ...
    public static int getVersionCode() {
        try {
            return MyApplicaion.getContext()
                    .getPackageManager()
                    .getPackageInfo(MyApplicaion.getContext().getPackageName(), 0)
                    .versionCode;
    ...
    public static boolean isWifiOpen() {
        ConnectivityManager cm = (ConnectivityManager) MyApplicaion.getContext().getSystemService(Context.CONNECTIVITY_SERVICE);
        NetworkInfo info = cm.getActiveNetworkInfo();
    ...
    public static void copyTextToBoard(String string) {
        ...
        ClipboardManager clip = (ClipboardManager) MyApplicaion.getContext()
     ...
     * @param id
     */
    public static void clearNotifaction(int id) {
        NotificationManager notiManager = (NotificationManager) MyApplicaion.getContext().getSystemService(NOTIFICATION_SERVICE);
